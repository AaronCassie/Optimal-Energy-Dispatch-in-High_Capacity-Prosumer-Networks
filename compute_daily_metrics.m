...
% Build a daily summary once the hourly clearing for the day is fixed.
...
% Mean daily revenue is used by some fairness policies, (these were removed, remove this).
R_mean = mean(R_day);
